...
<!--          <el-input v-model="query_record_form.payment_status" placeholder="请输入付款状态" style="width: 250px;" clearable/>-->
    ...
    <div class="table-container">
      <el-table :data="purchase_record_information_form" v-loading="loading" stripe style="width: 100%" @selection-change="val => selected = val.map(v=>v.purchase_id)">
...
<style scoped>
/* purchaseRecord - 专属样式（共享样式在 shared.css） */
</style>